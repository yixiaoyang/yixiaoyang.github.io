...
1. threshold.png：阈值分割算法，迅速分割出感兴趣的区域（显示屏亮色部分）
2. dilate、erode：腐蚀和膨胀算法，用于消除‘麻点’噪声，图像效果好的话可以不使用
3. canny.png：canny算法检测边缘轮廓
4. contours.png：寻找轮廓中的闭包，找出面积较大的区块，拟合成四边形，确定四边形的定点
5. transfer0.png：透视变换，消除畸变，就是将感兴趣的区域摆正、恢复像素尺寸的旋转拉伸过程
...
![opencv-contours.png](http://cdn5.snapgram.co/images/2016/12/19/opencv-contours.png)
